...
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1002432498240').split() if id_pattern.search(auth_channel)]
...
SHORTLINK_API = environ.get('e6509c2224116c05a356356950bb2139c36b5e3f')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/TamillRockerznet')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Tamil_Mob_Discussion')
